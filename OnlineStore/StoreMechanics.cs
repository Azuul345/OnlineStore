...
namespace OnlineStore
{
    internal class StoreMechanics
    {
        ...
        public static void ShowcaseCart(List<Product> cart)
        {   int totalItems = 0;
            double totalSum = 0;
            ...
            //int choice = StoreMechanics.ValueCheckInt("Enter your choice");
            //if (choice == 1)
            //{
            //    Console.WriteLine($"Applying Discount value for {}");
            //}
        ...
        public static void EnterShop(Customer c)
        {
            ...
            while (inStore)
            {
                ...
                switch (storeChoice)
                {
                    ...
                    case 3:
                        Console.WriteLine("Check out");
                        StoreMechanics.CheckOut(c,c.Cart);
                        break;
                    case 4:
